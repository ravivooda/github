...
//    self.navigationItem.rightBarButtonItem = addButton;
    ...
    NSURL *url = [[NSURL alloc] initWithString:@"https://api.github.com/user/repos?type=all"];
    
    NSURLRequest *theRequest = [[NSURLRequest alloc] initWithURL:url cachePolicy:NSURLCacheStorageNotAllowed timeoutInterval:30.0f];
